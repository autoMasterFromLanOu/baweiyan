package com.ba.dllo.mygift.utils;
...
//    //GsonRequest(带tag标签的方便通过标签删除)
//    public <T> void _addRequest(String url, Class<T> mClass, Response.Listener<T> listener, Response.ErrorListener errorListener, String tag) {
//        GsonRequest gsonRequest = new GsonRequest(Request.Method.GET, url, mClass, errorListener, listener);
//
//        addRequest(gsonRequest);
//    }
